<div class="container">
  <div class="row">
    <div class="col-md-12">
      <!-- col-md-12 -->
      <h3 class="text-info"><i class="fa fa-shopping-basket fa-3x" aria-hidden="true"></i> Checkout</h3><hr>
    </div>

    <div class="col-md-6 text-secondary">
      <h5 class="text-secondary"><i class="fa fa-truck" aria-hidden="true"></i> Delivery to</h5><hr>
    ...
    <div class="col-lg-6 text-secondary">
      <h5 class="text-dark"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> Payment Method</h5><hr>
    ...
    <div class="col-lg-12 text-secondary"><hr>
      <h5 class="text-secondary"><i class="fa fa-opencart" aria-hidden="true"></i> Item Summary</h5><hr>
