<?php
 ...
 class mUser extends CI_Model
 {
       ...
       public function mUserList($fname , $lname,$gender){
              //SQL Statement
              $SQL = "SELECT * FROM a_register WHERE 1 ";
              if ($fname !='') {
       ...
       public  function mSave($data){
              if ($this->db->insert('a_register',$data)) { //INSERT .... INTO register
                return 'success';
              }else{
                return 'error';
              }
       ...
       public function mRemove($data){
            if ($this->db->delete('a_register',$data)) { // DELETE FROM register ....
      ...
      //Update function
       public function mUpdate($id,$data){
            ...
            if ($this->db->update('a_register',$data)) { // UPDATE SET ...
              return "success";
            }else{
              return 'error';
         }
